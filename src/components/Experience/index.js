    ...
    const experiences = [
      {
        ...
        achievements: [
          "Designed and implemented intuitive UI components, improving user engagement by 30%.",
          "Optimized website responsiveness, ensuring seamless experience across all devices.",
          "Developed interactive prototypes in Figma, accelerating development cycles by 25%.",
          "Collaborated with developers to integrate UI/UX improvements, reducing design-to-development friction.",
          "Provided mentorship and design guidance to junior interns, fostering a collaborative learning environment.",
        ],
      },
    ];
          ...
          <div className="space-y-8">
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <p className="text-gray-300 font-medium">Location: {exp.location}</p>
                ...
                <div className="mt-4">
                  ...
                  <ul className="mt-2 flex flex-wrap gap-2">
                    {exp.skills.map((skill, idx) => (
                      <li key={idx} className="bg-gray-700 text-white px-3 py-1 rounded-full text-sm">
                        {skill}
                      </li>
                    ))}
                  </ul>
